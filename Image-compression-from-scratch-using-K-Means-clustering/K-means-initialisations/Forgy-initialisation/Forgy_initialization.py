...
# First we will try with random initialization or Forgy Initialization

""" This method is one of faster K-means intialization method. If we select K clusters,
this method selects K points from the data as the initial points at random. By randomly 
selecting points from data, we are making it more probable to get a point that lies
very close to the modes """
...
for K in num_clusters:
    ...
    %%time
    # random initialization or Forgy Initialization
    def init_cents(X, K):
